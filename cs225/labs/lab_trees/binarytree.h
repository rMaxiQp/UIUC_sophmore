...
class BinaryTree
{
  ...
  private:
     ...
     * @param subRoot The current node in the recursion
     */
    bool isOrdered(Node* subRoot, T hold, bool isLeft) const;
     ...
     * @param subRoot The current node in the recursion
     * @param track The vector of vectors
     * @param temp The vector
     */
    void printPaths(Node* subRoot, vector<vector<T>> &track, vector<T> temp) const;

    /**
     * Private helper function for the public printPaths function.
     * @param subRoot The current node in the recursion
     * @param sum The distance
     */
