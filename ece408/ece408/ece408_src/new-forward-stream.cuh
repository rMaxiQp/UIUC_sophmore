...
void forward<gpu, float>(mshadow::Tensor<gpu, 4, float> &y, const mshadow::Tensor<gpu, 4, float> &x, const mshadow::Tensor<gpu, 4, float> &w)
{
  ...
  if(M == M_first)
  {
    ...
    cudaMalloc((void **)&device_input_1, K * K * M * H_out_first * W_out_first * sizeof(float));
    cudaMalloc((void **)&device_input_2, K * K * M * H_out_first * W_out_first * sizeof(float));
    cudaMalloc((void **)&device_input_3, K * K * M * H_out_first * W_out_first * sizeof(float));
    ...
    for(int i = 0; i < B; i+=4)
    {
      ...
      matmat_first<<<dimGrid, dimBlock, 0, s>>>(device_input, y.dptr_ + M * i * W_out_first * H_out_first);
      matmat_first<<<dimGrid, dimBlock, 0, s1>>>(device_input_1, y.dptr_ + M *(i + 1) * W_out_first * H_out_first);
      matmat_first<<<dimGrid, dimBlock, 0, s2>>>(device_input_2, y.dptr_ + M * (i + 2) * W_out_first * H_out_first);
      matmat_first<<<dimGrid, dimBlock, 0, s3>>>(device_input_3, y.dptr_ + M *(i + 3) * W_out_first * H_out_first);
    }
  ...
  else
  {
    ...
    cudaMalloc((void **)&device_input_1, K * K * M * H_out_second * W_out_second * sizeof(float));
    cudaMalloc((void **)&device_input_2, C_second * K * K * M * H_out_second * W_out_second * sizeof(float));
    cudaMalloc((void **)&device_input_3, K * K * M * H_out_second * W_out_second * sizeof(float));
